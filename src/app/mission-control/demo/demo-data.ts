...
export const DEMO_GOALS = {
  ...
  goals: [
    ...
    { label: "Revenue", description: "Hit $40K MRR through a mix of audits, sprints, and advisory retainers" },
  ],
  cta_url: "https://atlasops.co/book",
...
export const DEMO_GA4: import("@/lib/ga4").GA4Metrics = {
  ...
  topSources: [
    ...
    { source: "x", sessions: 98, percentage: 8 },
