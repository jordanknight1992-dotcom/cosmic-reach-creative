...
export const metadata: Metadata = {
  ...
  description:
    "A focused working session that identifies what's slowing growth and gives leaders a prioritized action plan on the spot.",
  alternates: { canonical: `${siteConfig.domain}/clarity-session` },
};
