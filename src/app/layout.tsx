...
export const metadata: Metadata = {
  title: {
    default: `${SITE.name} | Performance Infrastructure for Marketing Teams`,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `${SITE.name} - Performance Infrastructure for Marketing Teams`,
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: `${SITE.name} | Performance Infrastructure for Marketing Teams`,
    description: SITE.description,
